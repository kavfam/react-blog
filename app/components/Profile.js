...
function Profile() {
  ...
  // in useState() can specify initial values
  ...
  useEffect(() => {
    ...
    // in dependency array below we are watching for changes to startFollowingRequestCount
  ...
  useEffect(() => {
    ...
    // in dependency array below we are watching for changes to stopFollowingRequestCount
  ...
  function stopFollowing() {
    setState(draft => {
      // also now need to have a useEffect for below property
